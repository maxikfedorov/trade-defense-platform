...
EXCEL_PATH=os.getenv("EXCEL_PATH","/app/elevators.xlsx")
TABLE_NAME=os.getenv("TABLE_NAME","public.elevators")
...
def main():
    ...
    # Сопоставим заголовки
    colmap = {}  # входная колонка -> выходное имя
    for c in df.columns:
